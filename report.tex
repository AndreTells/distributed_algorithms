...
\bibitem{sendMan}
  The Open Group. "send(3p) — POSIX Programmer's Manual." Linux Manual Pages, 2017, man7.org.

\bibitem{recvMan}
  The Open Group. "recv(3p) — POSIX Programmer's Manual." Linux Manual Pages, 2017, man7.org.

\bibitem{socket-geeks-for-geeks}
  \url{https://www.geeksforgeeks.org/c/socket-programming-cc/}

\bibitem{sockets-medium}
  \url{https://medium.com/@coderx_15963/basic-tcp-ip-networking-in-c-using-posix-9a074d65bb35}
